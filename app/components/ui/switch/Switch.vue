...
<template>
  ...
  >
    <span 
      class="pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform duration-200 group-data-[state=checked]:translate-x-5 group-data-[state=unchecked]:translate-x-0" 
    />
  </SwitchRoot>
</template>
